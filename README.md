...
<i>**Meterpreter payload for all platforms**</i>

Venomsploit is a python based tool designed for Termux users.<br>This script generates payloads using metasploit-framework.<br>It works both on rooted and non rooted devices. 
